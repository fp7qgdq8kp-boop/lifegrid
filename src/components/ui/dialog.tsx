  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-4 z-50 max-h-[calc(100svh-2rem)] w-[min(92vw,760px)] -translate-x-1/2 overflow-y-auto overscroll-contain rounded-[1.25rem] border border-white/10 bg-slate-950/95 p-6 shadow-2xl [-webkit-overflow-scrolling:touch] sm:top-1/2 sm:max-h-[calc(100dvh-2rem)] sm:-translate-y-1/2 sm:rounded-[1.75rem]",
          className
        )}
        {...props}
      >
