...
export function AppShell({ children }: { children: ReactNode }) {
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1440px] flex-col gap-6 px-4 py-4 lg:flex-row lg:px-6 lg:py-6">
        <aside className="rounded-[1.75rem] border border-white/8 bg-slate-950/80 p-5 shadow-panel backdrop-blur-sm lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)] lg:w-[320px] lg:shrink-0">
          <div className="mb-8">
